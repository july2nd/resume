...
\mobile{18900000000}     % optional, remove the line if not wanted
\email{xxx@gmail.com}        % optional, remove the line if not wanted
\nopagenumbers{}
\begin{document}
\maketitle
\section{工作经历}

\cventry{2017.10-2018.03}{IBM CDL}{Machine Learning on z/OS Team}{}{}{主要负责机器学习平台前端项目整合，以及部分功能开发和构建. 主要工作内容包括以下几个方面：\\
	1.使用NodeJS 实现一个从 Cloudant 数据库中提取加密数据的小工具, migration.\\
	2.使用React，Redux 和 NodeJS 实现 (大)文件上传下载功能， 文件类型包括 tar.gz, zip, Swagger YAML etc.\\
	3.使用React，Redux 和 NodeJS 实现数据源信息加密解密功能.\\
}
\vspace*{0.1\baselineskip}

\cventry{2017.07-2017.09}{IBM CDL}{Machine Learning on z/OS Team}{}{}{主要负责实现机器学习平台案例，主要工作内容包括以下几个方面：\\
	1.学习使用Numpy, Pandas, Matplot, Brunel , Scikit Learn各种机器学习库.\\
	2.使用Python 实现模型template.\\
	3.使用Scala 实现模型template.\\
}
\vspace*{0.1\baselineskip}


\cventry{2017.01-2017.06}{IBM CDL}{Machine Learning on z/OS Team}{}{}{主要负责应用容器化和产品持续构建CI/CD. 期间通过有效地采用多种开源工具，极大地提升了产品的开发，构建和测试效率，并获得了2017年 IBM Team Delivery Excellence Award and Rising Star Award.主要工作内容包括以下几个方面：\\
	1.使用Docker 容器化应用，并使用Kubernetes 对容器进行编排和管理.\\
	2.使用Jenkins 和Shell 脚本实现Docker Images （Scala，NodeJS，Python，Go 等多种运行时环境）的自动化构建.\\
	3.使用Ansible 实现产品的自动化部署.\\
	4.使用Selenium，Behave，Allure 和Python 脚本实现产品 E2E 自动化测试.\\
	5.使用Jenkins，Maven 和 Nexus 实现 Scala 项目自动构建和版本管理.\\
	6.负责Docker Registry，Jenkins Cluster，Nexus，Spark，Hadoop的搭建和维护.
}
\vspace*{0.1\baselineskip}

\cventry{2016.06-2016.12}{IBM CDL}{Commerce on Cloud Team}{}{}{主要负责微服务Docker化，自动化构建和部署. 主要工作内容包括以下几个方面:\\
	1.使用Docker实现微服务的容器化.\\
	2.使用Jenkins实现微服务的自动化构建.\\
	3.使用IBM Urban Code Deploy（UCD）实现微服务的自动化部署.\\
	4.使用ELK 实现微服务的日志收集和展示.\\
	5.使用Registor，Consul，Consul Template实现微服务的服务发现.\\
	6.实现了微服务在Marathon/Mesos上的自动化部署.
}
\vspace*{0.1\baselineskip}

\cventry{2015.07-2016.05}{IBM CDL}{Commerce on Prem Team}{}{}{主要参与跨境电商平台项目 Cross Boarder Trade 中的Catalog，Cart，Calculation，Passport 模块和数据库查询工具AutoQuery的部分开发和UT，用到的技术主要有Java、JQuery、Spring、JSP、Bootstrap、DB2 、Liberty等.}
\vspace*{0.1\baselineskip}

\section{实习经历}

%%\cventry{2015.04-2015.06}{IBM CDL}{Commerce on Prem Team}{}{}{主要参与OMNI Service项目，所做工作主要是开发购物车模块和UT. 主要用到的技术有Java、DB2、Liberty等.}
%%\vspace*{0.1\baselineskip}
...
\cventry{2014.06-2015.02}{滴滴出行}{产品技术部大数据组}{}{}{方向为反作弊，主要工作为挖掘和分析作弊特征，制定反作弊策略.\\
	...
	4.使用机器学习方法（SVM, Logistic Regression）建立司机信用评级体系.
}
