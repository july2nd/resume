...
\maketitle
\section{工作经历}
\cventry{2016.12-2017.07}{IBM CDL}{Machine Learning on z/OS Team}{}{}{主要负责应用容器化和产品持续构建.期间通过有效地采用多种开源工具，极大地提升了产品的开发，构建和测试效率，并获得了2017年 IBM Team Delivery Excellence Award.主要工作内容包括以下几个方面：\\
...
\cventry{2016.04-2016.12}{IBM CDL}{Commerce on Cloud Team}{}{}{主要负责数据库查询工具AutoQuery 的开发，Docker化，自动化构建和部署.主要工作内容包括以下几个方面:\\
...
\cventry{2015.07-2016.04}{IBM CDL}{Commerce on Prem Team}{}{}{主要参与跨境电商平台项目 Cross Boarder Trade 中的Catalog，Cart，Calculation，Passport 模块的开发和UT，用到的技术主要有Java、JQuery、Spring、JSP、DB2 、Liberty等.}
\vspace*{0.1\baselineskip}
